 ...
 * 
 */
@WebServiceClient(name = "ServiceHelloService", targetNamespace = "http://service.ry.com/", wsdlLocation = "http://localhost:9001/Service/ServiceHello?wsdl")
public class ServiceHelloService
    extends Service
{

    private final static URL SERVICEHELLOSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(com.ry.client.ServiceHelloService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.ry.client.ServiceHelloService.class.getResource(".");
    ...
    public ServiceHelloService() {
        super(SERVICEHELLOSERVICE_WSDL_LOCATION, new QName("http://service.ry.com/", "ServiceHelloService"));
    }
    ...
    public ServiceHello getServiceHelloPort() {
        return super.getPort(new QName("http://service.ry.com/", "ServiceHelloPort"), ServiceHello.class);
    }
    ...
    public ServiceHello getServiceHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ry.com/", "ServiceHelloPort"), ServiceHello.class, features);
    }
