 ...
 * generated in the com.ry.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValue_QNAME = new QName("http://service.ry.com/", "getValue");
    private final static QName _GetValueResponse_QNAME = new QName("http://service.ry.com/", "getValueResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ry.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ry.com/", name = "getValue")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ry.com/", name = "getValueResponse")
